...
class ScanConnectSecux extends PureComponent {
    ...
    reload = () => {
        ...
        SecuxReactNativeBLE.StartScan(this.AddDevice, this.DeleteDevice);
    }
    ...
    _onSelectDevice = async (device) => {
        ...
        try {
            ...
            let otp = '42960705'
            // await this.secuxConnect.SendOTP(otp);
    ...
    DeleteDevice = (device) => {
        this.setState({
            devices: this.state.devices.filter(x => x.id !== device.id)
        });
    }
    ...
    otp_processing = async () => {
        ...
        if (success) this.setState({ showOtpDialog: false });
    };
        ...
        return (
            <SafeAreaView style={styles.mainWrapper}>
                ...
                <View style={{ backgroundColor: "white" }}>
                    <Dialog.Container visible={this.state.showOtpDialog}>
